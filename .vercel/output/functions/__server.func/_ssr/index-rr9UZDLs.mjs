...
import { R } from "./router-Cl9Gk8_E.mjs";
import { R as Rocket, D as Download, A as ArrowUpRight, C as ChevronLeft, a as ChevronRight, G as Github, P as Phone, M as Mail, b as MapPin, L as Linkedin, X, c as Menu } from "../_libs/lucide-react.mjs";
...
const kprpaperImg = "/assets/kprpaper-DO7GNJs7.jpeg";
const cert7 = "/assets/cert7-DoyWaYl-.png";
const cert8 = "/assets/cert8-DKoVrQuZ.png";
const skillGroups = [{
  idx: "  01",
  title: "Programming",
  ...
  items: ["Scikit-learn", "Pandas", "NumPy", "Data Visualization", "Matplotlip"]
}, {
  idx: "  03",
  title: "Web Tech",
  ...
  idx: "  04",
  title: "Tools",
  items: ["Git & GitHub", "Docker", "Jupyter", "VS Code", "Power BI", "AWS", "Vercel", "Render", "Railway"]
}, {
  idx: "  05",
  title: "Core Concepts",
  items: ["DSA", "OOPS", "Machine Learning", "Data Analysis &EDA", "Networking"]
}];
const codingProfiles = [{
  platform: "LeetCode",
  url: "https://leetcode.com/u/DhakshathaSelvaraj/",
  problems: "170+",
  highlight: "Rating: 1359",
  badge: "1",
  certification: "",
  desc: "Active in LeetCode contests with strong competitive programming foundation.",
  bgImage: "https://leetcode.com/static/images/LeetCode_logo_rvs.png"
}, {
  platform: "Skillrack",
  url: "https://www.skillrack.com/faces/candidate/trackshome.xhtml",
  problems: "700+",
  highlight: "Problem Solving",
  badge: "",
  certification: "5",
  desc: "Extensive problem-solving experience across multiple domains.",
  bgImage: "https://www.skillrack.com/images/brand/logo.png"
}, {
  platform: "CodeChef",
  url: "https://www.codechef.com/users/dhakshu_08",
  problems: "100+",
  highlight: "Programming language",
  badge: "",
  certification: "",
  desc: "Strengthened programming language.",
  bgImage: "https://cdn.codechef.com/images/cc-logo.svg"
}, {
  platform: "HackerRank",
  url: "https://www.hackerrank.com/profile/dhatchuu08",
  problems: "",
  highlight: "DSA",
  badge: "1",
  certification: "1",
  desc: "Demonstrated strong foundation in Data structure and algorithms.",
  bgImage: "https://hrcdn.net/fcore/assets/brand/logo-new-white-green-a5cb16e0ae.svg"
}];
const achievements = [
  {
    title: "Smart India Hackathon",
    place: " Sri Eshwar College of Engineering",
    desc: "Shortlisted in Internal round of India's largest national-level innovation hackathon focused on AI-driven solutions.",
    bgImage: sihImg
  },
...
const projects = [{
  ...
  links: {
    demo: "#",
    github: "https://github.com/DHAKSHATHA0/careermate.git"
  }
}, {
  n: "02",
  ...
  links: {
    demo: "#",
    github: "https://github.com/Harinid27/PhishingDetection.git"
  }
}, {
  n: "03",
  ...
  links: {
    demo: "#",
    github: "https://github.com/DHAKSHATHA0/resumeanalyser.git"
  }
}, {
  n: "04",
  ...
  links: {
    demo: "#",
    github: "https://github.com/DHAKSHATHA0/littlebloom.git"
  }
}, {
  n: "05",
  ...
  links: {
    demo: "#",
    github: "https://github.com/DHAKSHATHA0/Renelsense.git"
  }
}, {
  n: "06",
  ...
  links: {
    demo: "#",
    github: "https://github.com/DHAKSHATHA0/language_Learning.git"
  }
}];
const education = [{
...
function Portfolio() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "coding-profiles", className: "py-24 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: codingProfiles.map((cp) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bracket relative overflow-hidden group", style: {
        minHeight: "220px",
        border: "1px solid rgba(6,182,212,0.18)",
        borderRadius: "4px",
        transition: "all .3s ease"
      }, children: [
        cp.bgImage && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: cp.bgImage, alt: "", className: "absolute inset-0 w-full h-full object-cover opacity-10 group-hover:opacity-20 transition-opacity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/60 to-black/80" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: cp.url, target: "_blank", rel: "noopener noreferrer", className: "text-2xl font-bold text-cyan hover:text-white transition-colors flex items-center gap-2", children: [
            cp.platform,
            " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "achievements", className: "py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-5", children: achievements.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bracket relative overflow-hidden group cursor-pointer", style: {
        minHeight: "320px",
        border: "1px solid rgba(6,182,212,0.18)",
        borderRadius: "4px",
        transition: "all .3s ease"
      }, onClick: () => a.bgImage && setFullscreenAchiev(a), children: [
        a.bgImage && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: a.bgImage, alt: "", className: "absolute inset-0 w-full h-full object-cover" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/55 group-hover:bg-black/40 transition-colors" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 p-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-20", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => scrollCerts("left"), className: "absolute -left-5 top-1/2 -translate-y-1/2 z-10 w-9 h-9 flex items-center justify-center rounded-full bg-cyan text-black hover:bg-cyan/80 transition shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { size: 18 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => scrollCerts("right"), className: "absolute -right-5 top-1/2 -translate-y-1/2 z-10 w-9 h-9 flex items-center justify-center rounded-full bg-cyan text-black hover:bg-cyan/80 transition shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 18 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-x-auto scrollbar-hide", ref: certTrackRef, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
                ...
                ` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `cert-track${certPaused ? "" : " cert-track-anim"}`, children: (certPaused ? certifications : certifications.concat(certifications)).map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-72 flex-shrink-0 cursor-pointer relative rounded-lg overflow-hidden shadow-lg", onClick: () => c.certImage && setFullscreenCert(c), children: c.certImage ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-6", children: projects.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tech-card bracket relative overflow-hidden group", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 p-8 flex flex-col justify-end h-full", style: {
          minHeight: "280px"
        }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              p.links.github && p.links.github !== "#" && /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: p.links.github, target: "_blank", rel: "noopener noreferrer", onClick: (e) => e.stopPropagation(), className: "w-8 h-8 flex items-center justify-center rounded-full border border-cyan/40 text-cyan hover:bg-cyan hover:text-black transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { size: 14 }) })
            ] })
          ] }),
    ...
    fullscreenCert && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4", onClick: () => setFullscreenCert(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-3xl w-full bg-slate-900 rounded-xl overflow-hidden shadow-2xl", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "absolute top-3 right-3 z-10 w-9 h-9 flex items-center justify-center rounded-full bg-blue-500 text-white hover:bg-blue-400 transition", onClick: () => setFullscreenCert(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 18 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: fullscreenCert.certImage || "", alt: fullscreenCert.title, className: "w-full h-auto" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 bg-slate-900 border-t border-blue-900", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-blue-400 font-bold tracking-widest", children: fullscreenCert.issuer.toUpperCase() }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-1 text-lg font-extrabold text-white", children: fullscreenCert.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-sm text-blue-300", children: fullscreenCert.year })
      ] })
    ] }) }),
    fullscreenAchiev && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4", onClick: () => setFullscreenAchiev(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-3xl w-full bg-slate-900 rounded-xl overflow-hidden shadow-2xl", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "absolute top-3 right-3 z-10 w-9 h-9 flex items-center justify-center rounded-full bg-blue-500 text-white hover:bg-blue-400 transition", onClick: () => setFullscreenAchiev(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 18 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: fullscreenAchiev.bgImage || "", alt: fullscreenAchiev.title, className: "w-full h-auto" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 bg-slate-900 border-t border-blue-900", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-extrabold text-white", children: fullscreenAchiev.title }),
        fullscreenAchiev.achievement && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-blue-400 font-bold text-sm tracking-widest", children: fullscreenAchiev.achievement }),
        fullscreenAchiev.place && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-xs text-blue-300 tracking-widest", children: fullscreenAchiev.place.toUpperCase() }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-white border-l-2 border-blue-500 pl-3", children: fullscreenAchiev.desc })
      ] })
    ] }) })
  ] });
}
