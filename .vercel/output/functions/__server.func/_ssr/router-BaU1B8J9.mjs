...
const appCss = "/assets/styles-gngNr98X.css";
...
const $$splitComponentImporter = () => import("./index-Z-_kz0Jy.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of Dhakshatha — AI & Machine Learning student engineering intelligent solutions with Python, ML, Deep Learning and GenAI."
    }, {
      property: "og:title",
      content: "Dhakshatha — AI & ML Engineer Portfolio"
    }, {
      property: "og:description",
      content: "Building intelligent solutions through AI, ML, and Generative AI."
    }]
  }),
